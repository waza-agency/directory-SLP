...
const postData = {
  title: "Leonora Carrington y San Luis Potosí: Donde el Surrealismo Encontró un Hogar en México",
  title_en: "Leonora Carrington and San Luis Potosí: Where Surrealism Found a Home in Mexico",
  slug: "leonora-carrington-san-luis-potosi-museo-centro-artes-surrealism",
  excerpt: "Descubre la mágica conexión entre la surrealista británico-mexicana Leonora Carrington y San Luis Potosí, hogar del primer museo del mundo dedicado a su legado en el impresionante Centro de las Artes.",
  excerpt_en: "Discover the magical connection between British-Mexican surrealist Leonora Carrington and San Luis Potosí, home to the world's first museum dedicated to her legacy at the stunning Centro de las Artes.",
  category: "Arte y Cultura",
  tags: ["Leonora Carrington", "surrealism", "Centro de las Artes", "museum", "art", "culture", "Xilitla", "Las Pozas", "Edward James"],
  image_url: "https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=1600&h=900&fit=crop&q=80",
  status: "published",
...
<section id="introduction" class="mb-16 scroll-mt-8">
  ...
  <p class="text-lg leading-relaxed text-gray-700 mb-6">
    This guide explores Carrington's fascinating life, her special relationship with San Luis Potosí, and everything you need to know to experience her legacy at the stunning Centro de las Artes.
  </p>
</section>
...
<section id="who-was-leonora" class="mb-16 scroll-mt-8">
  ...
  <figure class="not-prose my-12">
    <div class="rounded-xl overflow-hidden shadow-lg">
      <img
        src="https://images.unsplash.com/photo-1541961017774-22349e4a1262?w=1200&h=675&fit=crop&q=80"
        alt="Abstract surrealist art representing dreamlike imagery"
        class="w-full h-auto"
        loading="lazy"
      />
    </div>
  ...
  <h3 class="text-2xl font-semibold text-gray-900 mb-4">The Paris Years and Max Ernst</h3>

  <p class="text-lg leading-relaxed text-gray-700 mb-6">
    In 1936, Carrington enrolled at Amédée Ozenfant's art academy in London. The following year, she met the German Surrealist Max Ernst at a London exhibition, beginning a passionate relationship that would change her life forever. The couple lived together in southern France, becoming central figures in the Surrealist movement.
  </p>

  <p class="text-lg leading-relaxed text-gray-700 mb-6">
    When World War II erupted and Ernst was interned as an "enemy alien," Carrington suffered a devastating breakdown. She fled to Spain, where she was hospitalized in a mental institution—an experience she later chronicled in her memoir "Down Below."
  </p>
  ...
  <p class="text-lg leading-relaxed text-gray-700 mb-6">
    In Mexico, Carrington found not only safety but creative freedom. She forged a close friendship with Spanish Surrealist Remedios Varo, married Hungarian photographer Emerico Weisz, raised two sons, and became a founding member of Mexico's women's liberation movement in the 1970s.
  </p>
...
<section id="connection-slp" class="mb-16 scroll-mt-8">
  ...
  <figure class="not-prose my-12">
    <div class="rounded-xl overflow-hidden shadow-lg">
      <img
        ...
        alt="Panoramic view of San Luis Potosí's historic architecture"
        class="w-full h-auto"
        loading="lazy"
      />
    </div>
  ...
  <p class="text-lg leading-relaxed text-gray-700 mb-6">
    The town's rich history of silver mining, its indigenous Huichol traditions, and its mystical desert surroundings—where peyote grows wild—provided the kind of magical realism that permeated Carrington's work. Here, the line between the physical and spiritual world blurs, much like in her paintings.
  </p>

  <h3 class="text-2xl font-semibold text-gray-900 mb-4">Cerro de San Pedro: Where History Meets Mystery</h3>

  <p class="text-lg leading-relaxed text-gray-700 mb-6">
    Cerro de San Pedro, the historic mining town just 20 kilometers from San Luis Potosí's capital where silver and gold were first discovered in 1592, also captured Carrington's imagination. The town's decaying grandeur—churches built on silver wealth now standing among ruins—embodied the transformation and decay themes that fascinated Surrealists.
  </p>
  ...
  <div class="not-prose my-8 bg-amber-50 border-l-4 border-amber-500 p-6 rounded-r-lg">
    <p class="text-amber-900">
      <strong>The Artist Residency Program:</strong> Today, the Museo Leonora Carrington hosts artist residencies that often explore the same themes and places that inspired Carrington. Recent residents have traveled to Real de Catorce and Cerro de San Pedro to understand the impact of mining on local culture—just as Carrington once did.
    </p>
  </div>
</section>
...
<section id="museo-leonora" class="mb-16 scroll-mt-8">
  ...
  <figure class="not-prose my-12">
    <div class="rounded-xl overflow-hidden shadow-lg">
      <img
        src="https://images.unsplash.com/photo-1554907984-15263bfd63bd?w=1200&h=675&fit=crop&q=80"
        alt="Modern museum gallery interior with sculptures"
        class="w-full h-auto"
        loading="lazy"
      />
    </div>
  ...
  <p class="text-lg leading-relaxed text-gray-700 mb-6">
    Visitors can discover a unique collection that reveals one of the most fascinating personalities of the 20th century:
  </p>
  ...
  <div class="not-prose my-12">
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      <div class="bg-gradient-to-br from-purple-50 to-pink-50 p-6 rounded-xl shadow-md">
        ...
        <p class="text-gray-700">Seven large-scale bronze sculptures displayed in the museum's patios, featuring Carrington's mythological creatures</p>
      </div>
      <div class="bg-gradient-to-br from-purple-50 to-pink-50 p-6 rounded-xl shadow-md">
        <div class="text-4xl mb-4">💎</div>
        <h5 class="text-lg font-semibold text-gray-900 mb-3">Jewelry</h5>
        <p class="text-gray-700">Personal jewelry pieces designed by the artist, showcasing her interest in alchemy and transformation</p>
      </div>
      <div class="bg-gradient-to-br from-purple-50 to-pink-50 p-6 rounded-xl shadow-md">
        <div class="text-4xl mb-4">🖼️</div>
        <h5 class="text-lg font-semibold text-gray-900 mb-3">Engravings & Drawings</h5>
        <p class="text-gray-700">Etchings, lithographs, and drawings that reveal her creative process and recurring themes</p>
      </div>
      <div class="bg-gradient-to-br from-purple-50 to-pink-50 p-6 rounded-xl shadow-md">
        <div class="text-4xl mb-4">📦</div>
        <h5 class="text-lg font-semibold text-gray-900 mb-3">Personal Objects</h5>
        <p class="text-gray-700">Intimate belongings that offer insight into her daily life and artistic inspirations</p>
      </div>
      <div class="bg-gradient-to-br from-purple-50 to-pink-50 p-6 rounded-xl shadow-md">
        <div class="text-4xl mb-4">🎭</div>
        <h5 class="text-lg font-semibold text-gray-900 mb-3">Temporary Exhibitions</h5>
        <p class="text-gray-700">Rotating exhibits about Surrealism and works influenced by Carrington's legacy</p>
      </div>
      <div class="bg-gradient-to-br from-purple-50 to-pink-50 p-6 rounded-xl shadow-md">
        <div class="text-4xl mb-4">📚</div>
        <h5 class="text-lg font-semibold text-gray-900 mb-3">Research Center</h5>
        <p class="text-gray-700">The International Center for the Study and Dissemination of Surrealism</p>
      </div>
    </div>
  </div>
  ...
  <div class="not-prose my-12 bg-purple-50 border-2 border-purple-200 rounded-2xl overflow-hidden shadow-lg">
    ...
    <div class="p-8">
      <p class="text-gray-700 mb-4">
        The Museo Leonora Carrington is today considered one of the "10 museums you must visit" in the Mexican Republic. Its combination of world-class art, stunning architecture, and cultural programming has made it a must-see destination for visitors to San Luis Potosí.
      </p>
...
<section id="centro-artes" class="mb-16 scroll-mt-8">
  ...
  <figure class="not-prose my-12">
    <div class="rounded-xl overflow-hidden shadow-lg">
      <img
        src="https://images.unsplash.com/photo-1582555172866-f73bb12a2ab3?w=1200&h=675&fit=crop&q=80"
        alt="Historic architecture with modern museum elements"
        class="w-full h-auto"
        loading="lazy"
      />
    </div>
  ...
  <p class="text-lg leading-relaxed text-gray-700 mb-6">
    The building was designed by architect Carlos Suárez Fiallo in the late 19th century following the Panopticon model developed by English philosopher Jeremy Bentham. This revolutionary (and controversial) prison design placed a central observation tower at the heart of the structure, with eight corridors radiating outward like spokes of a wheel—allowing guards to observe all prisoners from a single point without the inmates knowing if they were being watched.
  </p>
  ...
  <div class="not-prose my-8 bg-gray-50 border-l-4 border-gray-400 p-6 rounded-r-lg">
    <div class="flex items-start gap-3">
      ...
      <div>
        ...
        <p class="text-gray-700 mb-3">
          The panopticon-type prison first opened in 1890 and functioned as the State's jail from 1904 until 1999, when inmates were transferred to a new facility. The building's haunting beauty—with its grand facades, elegant columns, and radial design—made it a perfect candidate for cultural transformation.
        </p>
      </div>
    </div>
  </div>

  <h3 class="text-2xl font-semibold text-gray-900 mb-4">The Transformation</h3>

  <p class="text-lg leading-relaxed text-gray-700 mb-6">
    In 2004, INAH (National Institute of Anthropology and History) and CONACULTA selected architect Alejandro Sánchez García to lead the transformation. The intervention was profound: limestone blocks from the original cells were removed piece by piece and reassembled in new configurations. Modern glass and steel structures were woven into the historic framework.
  </p>

  <p class="text-lg leading-relaxed text-gray-700 mb-6">
    Today, the Centro de las Artes features:
  </p>
  ...
  <div class="not-prose my-12 bg-green-50 border-2 border-green-300 rounded-xl p-8">
    ...
    <div class="space-y-4">
      <div class="bg-white p-5 rounded-lg shadow-sm border-l-4 border-green-500">
        ...
        <p class="text-gray-700">Former prison yards transformed into open-air galleries and gathering spaces</p>
      </div>
      <div class="bg-white p-5 rounded-lg shadow-sm border-l-4 border-green-500">
        <p class="font-semibold text-gray-900 mb-2">Art Education Schools</p>
        <p class="text-gray-700">Training the next generation of Mexican artists in various disciplines</p>
      </div>
      <div class="bg-white p-5 rounded-lg shadow-sm border-l-4 border-green-500">
      ...
      <div class="bg-white p-5 rounded-lg shadow-sm border-l-4 border-green-500">
        <p class="font-semibold text-gray-900 mb-2">Central Watchtower</p>
        <p class="text-gray-700">The original panopticon tower, now painted with rotating artistic themes</p>
      </div>
    </div>
  </div>

  <p class="text-lg leading-relaxed text-gray-700 mb-6">
    The juxtaposition of the building's dark history with its present purpose as a celebration of creativity mirrors many of Carrington's own themes—transformation, liberation, and the power of imagination to transcend physical limitations.
  </p>
</section>
...
<section id="xilitla-las-pozas" class="mb-16 scroll-mt-8">
  ...
  <figure class="not-prose my-12">
    <div class="rounded-xl overflow-hidden shadow-lg">
      <img
        ...
        alt="Lush jungle waterfall representing the magical landscapes of the Huasteca"
        class="w-full h-auto"
        loading="lazy"
      />
    </div>
  ...
  <h3 class="text-2xl font-semibold text-gray-900 mb-4">Edward James: The Millionaire Dreamer</h3>

  <p class="text-lg leading-relaxed text-gray-700 mb-6">
    Edward James (1907-1984) was a British poet and art collector who used his inherited fortune to support Surrealist artists including Salvador Dalí, René Magritte, and Leonora Carrington. In the 1960s and 70s, James poured millions of dollars into creating Las Pozas—36 surrealist concrete structures spread across 20 acres of tropical jungle, more than 2,000 feet above sea level.
  </p>

  <p class="text-lg leading-relaxed text-gray-700 mb-6">
    Artists James befriended in Mexico visited him regularly at Las Pozas, including Gunther Gerzso, Remedios Varo, and Leonora Carrington. Carrington painted a mural on the wall of James's home in Xilitla (now the hotel El Castillo)—a personal touch that connects her directly to this magical place.
  </p>
  ...
  <div class="not-prose my-12 grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
    <div class="rounded-xl overflow-hidden shadow-lg">
      <img
        src="https://images.unsplash.com/photo-1552537376-3abf35237215?w=700&h=500&fit=crop&q=80"
        alt="Turquoise waters representing Las Pozas pools"
        class="w-full h-auto"
        loading="lazy"
      />
    </div>
...
<section id="visiting" class="mb-16 scroll-mt-8">
  <div class="not-prose mb-8">
    ...
    <p class="text-lg text-gray-600 mt-4 italic">
      Everything you need to experience Carrington's legacy in San Luis Potosí
    </p>
  </div>
  ...
  <h3 class="text-2xl font-semibold text-gray-900 mb-4">Suggested Itinerary: The Surrealist Route</h3>
      ...
      <div class="space-y-8">
        ...
        <div class="relative flex items-start gap-6">
          ...
          <div class="flex-1 bg-white p-6 rounded-xl shadow-md border border-gray-200">
            <h5 class="text-xl font-semibold text-gray-900 mb-3">Day 1: San Luis Potosí Capital</h5>
            <ul class="list-disc pl-6 text-gray-700 space-y-2">
              <li>Morning: Explore Centro de las Artes and Museo Leonora Carrington</li>
              <li>Afternoon: Walk the historic center, visit Cathedral and baroque churches</li>
              <li>Evening: Dinner in the Plaza del Carmen area</li>
            </ul>
          </div>
        </div>
        ...
        <div class="relative flex items-start gap-6">
          ...
          <div class="flex-1 bg-white p-6 rounded-xl shadow-md border border-gray-200">
            <h5 class="text-xl font-semibold text-gray-900 mb-3">Day 2: Mining Towns</h5>
            <ul class="list-disc pl-6 text-gray-700 space-y-2">
              <li>Morning: Visit Cerro de San Pedro (20 min from SLP)</li>
              <li>Afternoon: Drive to Real de Catorce through the tunnel</li>
              <li>Evening: Stay overnight in Real de Catorce</li>
            </ul>
          </div>
        </div>
        ...
        <!-- Day 3-4 -->
        <div class="relative flex items-start gap-6">
          <div class="flex-shrink-0 w-16 h-16 bg-teal-500 rounded-full flex items-center justify-center text-white font-bold text-xl shadow-lg z-10">
            3-4
          </div>
          <div class="flex-1 bg-white p-6 rounded-xl shadow-md border border-gray-200">
            <h5 class="text-xl font-semibold text-gray-900 mb-3">Days 3-4: Huasteca Potosina</h5>
            <ul class="list-disc pl-6 text-gray-700 space-y-2">
              <li>Travel to Xilitla (approximately 6 hours from SLP)</li>
              <li>Visit Las Pozas surrealist garden</li>
              <li>See Carrington's mural at El Castillo</li>
              <li>Visit Museo Leonora Carrington Xilitla</li>
            </ul>
          </div>
        </div>
      </div>
...
<section id="conclusion" class="mb-16 scroll-mt-8">
  ...
  <p class="text-lg leading-relaxed text-gray-700 mb-6">
    Leonora Carrington's connection to San Luis Potosí reveals how this region's magical landscapes—from ghost mining towns to jungle gardens—have long attracted visionary artists seeking inspiration beyond the ordinary. Today, visitors can trace her footsteps through a remarkable cultural journey that encompasses world-class museums, architectural marvels, and some of Mexico's most surreal landscapes.
  </p>
  ...
  <p class="text-lg leading-relaxed text-gray-700 mb-6">
    Whether you're an art lover, architecture enthusiast, or simply curious traveler, the Museo Leonora Carrington and Centro de las Artes offer an unforgettable experience—one that connects you to one of the 20th century's most remarkable artists and the magical Mexican landscapes that inspired her.
  </p>
</section>
...
<section id="introduccion" class="mb-16 scroll-mt-8">
  ...
  <p class="text-lg leading-relaxed text-gray-700 mb-6">
    Leonora Carrington (1917-2011) no fue una artista ordinaria. Una rebelde debutante inglesa que huyó de su educación aristocrática para unirse al movimiento surrealista en París, eventualmente encontró su verdadero hogar en México, donde vivió durante casi siete décadas. Su conexión con San Luis Potosí—a través de místicos pueblos mineros, jardines surrealistas, y ahora un museo de clase mundial—crea una experiencia cultural imperdible para los amantes del arte que visitan esta región.
  </p>
</section>
...
<section id="quien-fue-leonora" class="mb-16 scroll-mt-8">
  ...
  <figure class="not-prose my-12">
    <div class="rounded-xl overflow-hidden shadow-lg">
      <img
        src="https://images.unsplash.com/photo-1541961017774-22349e4a1262?w=1200&h=675&fit=crop&q=80"
        alt="Arte surrealista abstracto representando imágenes oníricas"
        class="w-full h-auto"
        loading="lazy"
      />
    </div>
  ...
  <div class="not-prose my-8 bg-gray-50 border-l-4 border-gray-400 p-6 rounded-r-lg">
    <div class="flex items-start gap-3">
      ...
      <div>
        ...
        <p class="text-gray-700 mb-3">
          La madre irlandesa de Carrington y su niñera le introdujeron a la mitología celta y el folclore irlandés—imágenes que aparecerían después en todo su arte. Estas primeras historias de magia y transformación plantaron las semillas de su visión surrealista.
        </p>
        <p class="text-sm text-gray-600">
...
<section id="conexion-slp" class="mb-16 scroll-mt-8">
  ...
  <p class="text-lg leading-relaxed text-gray-800 mb-8 bg-blue-50 border-l-4 border-blue-400 p-6 rounded-r-lg">
    <strong>¿Por qué San Luis Potosí?</strong> Aunque Carrington vivía principalmente en la Ciudad de México, desarrolló una conexión especial con San Luis Potosí a través de sus visitas a sus pueblos mágicos—Real de Catorce y Cerro de San Pedro—lugares que se convirtieron en fuentes de inspiración para varias de sus obras.
  </p>
  ...
  <figure class="not-prose my-12">
    <div class="rounded-xl overflow-hidden shadow-lg">
      <img
        src="https://images.unsplash.com/photo-1518105779142-d975f22f1b0a?w=1200&h=675&fit=crop&q=80"
        alt="Vista panorámica de la arquitectura histórica de San Luis Potosí"
        class="w-full h-auto"
        loading="lazy"
      />
    </div>
  ...
  <p class="text-lg leading-relaxed text-gray-700 mb-6">
    Real de Catorce, el antiguo pueblo minero de plata encaramado en las montañas de San Luis Potosí, cautivó particularmente a Carrington. Este "pueblo fantasma," accesible solo a través de un túnel de 2.3 kilómetros excavado en la montaña, ofrecía el paisaje surrealista perfecto—haciendas abandonadas, mesetas desérticas, y una atmósfera de otro mundo que se alineaba perfectamente con su visión artística.
  </p>
...
<section id="museo-leonora" class="mb-16 scroll-mt-8">
  ...
  <figure class="not-prose my-12">
    <div class="rounded-xl overflow-hidden shadow-lg">
      <img
        src="https://images.unsplash.com/photo-1554907984-15263bfd63bd?w=1200&h=675&fit=crop&q=80"
        alt="Interior de galería de museo moderno con esculturas"
        class="w-full h-auto"
        loading="lazy"
      />
    </div>
  ...
  <p class="text-lg leading-relaxed text-gray-700 mb-6">
    El 22 de marzo de 2018, el Museo Leonora Carrington abrió sus puertas en San Luis Potosí, convirtiéndose en el primer museo del mundo dedicado enteramente a esta artista revolucionaria. El museo fue posible gracias a las generosas donaciones de Pablo Weisz Carrington, hijo de la artista, quien cumplió una promesa que le hizo a su madre de crear un tributo duradero a su obra.
  </p>
  ...
  <div class="not-prose my-12">
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      ...
      <div class="bg-gradient-to-br from-purple-50 to-pink-50 p-6 rounded-xl shadow-md">
        ...
        <p class="text-gray-700">Exhibiciones rotativas sobre el Surrealismo y obras influenciadas por Carrington</p>
      </div>
      <div class="bg-gradient-to-br from-purple-50 to-pink-50 p-6 rounded-xl shadow-md">
        <div class="text-4xl mb-4">📚</div>
...
<section id="centro-artes" class="mb-16 scroll-mt-8">
  ...
  <p class="text-lg leading-relaxed text-gray-700 mb-6">
    El Museo Leonora Carrington está alojado dentro de una de las conversiones arquitectónicas más notables de México: el Centro de las Artes de San Luis Potosí Centenario. Este impresionante complejo cultural fue alguna vez una penitenciaría en funcionamiento—una transformación que parece apropiada para una artista que pasó su vida explorando temas de confinamiento, liberación y metamorfosis.
  </p>
  ...
  <figure class="not-prose my-12">
    <div class="rounded-xl overflow-hidden shadow-lg">
      <img
        src="https://images.unsplash.com/photo-1582555172866-f73bb12a2ab3?w=1200&h=675&fit=crop&q=80"
        alt="Arquitectura histórica con elementos modernos de museo"
        class="w-full h-auto"
        loading="lazy"
      />
    </div>
  ...
  <p class="text-lg leading-relaxed text-gray-700 mb-6">
    El edificio fue diseñado por el arquitecto Carlos Suárez Fiallo a finales del siglo XIX siguiendo el modelo Panóptico desarrollado por el filósofo inglés Jeremy Bentham. Este diseño revolucionario (y controvertido) de prisión colocaba una torre de observación central en el corazón de la estructura, con ocho corredores irradiando hacia afuera como los radios de una rueda.
  </p>
  ...
  <div class="not-prose my-8 bg-gray-50 border-l-4 border-gray-400 p-6 rounded-r-lg">
    <div class="flex items-start gap-3">
      ...
      <div>
        ...
        <p class="text-gray-700 mb-3">
          La prisión tipo panóptico abrió por primera vez en 1890 y funcionó como la cárcel del Estado desde 1904 hasta 1999, cuando los reclusos fueron trasladados a una nueva instalación.
        </p>
      </div>
    </div>
  </div>
...
<section id="xilitla-las-pozas" class="mb-16 scroll-mt-8">
  ...
  <figure class="not-prose my-12">
    <div class="rounded-xl overflow-hidden shadow-lg">
      <img
        src="https://images.unsplash.com/photo-1596402184320-417e7178b2cd?w=1200&h=675&fit=crop&q=80"
        alt="Cascada en selva exuberante representando los paisajes mágicos de la Huasteca"
        class="w-full h-auto"
        loading="lazy"
      />
    </div>
  ...
  <p class="text-lg leading-relaxed text-gray-700 mb-6">
    Ninguna exploración de la conexión de Carrington con San Luis Potosí estaría completa sin mencionar Las Pozas—el jardín de esculturas surrealistas creado por su amigo y mecenas Edward James en Xilitla, en la región Huasteca de San Luis Potosí.
  </p>
  ...
  <div class="not-prose my-12 grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
    <div class="rounded-xl overflow-hidden shadow-lg">
      <img
        src="https://images.unsplash.com/photo-1552537376-3abf35237215?w=700&h=500&fit=crop&q=80"
        alt="Aguas turquesa representando las pozas de Las Pozas"
        class="w-full h-auto"
        loading="lazy"
      />
    </div>
  ...
  <p class="text-lg leading-relaxed text-gray-700 mb-6">
    El 19 de octubre de 2018, una segunda sede del Museo Leonora Carrington abrió en Xilitla, con esculturas, litografías y otras obras de la artista. Esto crea una peregrinación artística natural: desde el Centro de las Artes en la capital de San Luis Potosí hasta el país de las maravillas surrealista de Las Pozas, con la obra de Carrington como hilo conductor.
  </p>
</section>
...
<section id="conclusion" class="mb-16 scroll-mt-8">
  ...
  <p class="text-lg leading-relaxed text-gray-700 mb-6">
    La transformación de una prisión panóptica del siglo XIX en un centro para las artes, ahora hogar del legado de Carrington, es quizás el tributo más apropiado posible para una artista que pasó su vida explorando temas de confinamiento, liberación y transformación. En San Luis Potosí, su obra ha encontrado no solo un hogar, sino una metáfora perfecta.
  </p>
</section>
