...
const blogPost = {
  title: "Top 5 Cozy Cafés for Winter in San Luis Potosí",
  slug: "top-5-cozy-cafes-winter-san-luis-potosi",
  excerpt: "Looking for the best hot chocolate or a warm spot to work? We've rounded up the coziest corners in the city to escape the chill and enjoy San Luis Potosí's thriving café culture.",
  category: "Food & Drink",
  tags: ["cafés", "coffee", "winter", "hot chocolate", "cozy spots", "work from café", "San Luis Potosí"],
  image_url: "/images/blog/cozy-cafes-slp-header.jpg",
  content: `
...
<p><strong>Address:</strong> Two locations in San Luis Potosí (check their website)</p>
...
<p><em>Have a favorite cozy café we missed? Let us know in the comments or tag us on social media!</em></p>
  `,
  title_en: "Top 5 Cozy Cafés for Winter in San Luis Potosí",
  excerpt_en: "Looking for the best hot chocolate or a warm spot to work? We've rounded up the coziest corners in the city to escape the chill and enjoy San Luis Potosí's thriving café culture.",
  content_en: null // Will use main content
};

// Use main content for English version
blogPost.content_en = blogPost.content;

const postData = JSON.stringify(blogPost);
  ...
  res.on('end', () => {
    ...
    try {
      ...
      if (res.statusCode === 201) {
        ...
        console.log('Full URL: https://www.sanluisway.com' + result.post.url);
      } else {
