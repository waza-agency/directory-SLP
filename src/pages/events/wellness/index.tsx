...
export const getStaticProps: GetStaticProps = async ({ }) => {
  try {
    ...
    console.log('Wellness events found:', eventsData?.length || 0);
...
export default function WellnessEvents({ events }: WellnessEventsProps) {
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="relative bg-gradient-to-r from-green-600 to-teal-600 text-white">
        <div className="absolute inset-0">
          <Image
            src="/images/event-categories/wellness.webp"
            alt="Wellness Events"
            fill
        ...
        <div className="container mx-auto px-4 py-16 relative">
          <div className="max-w-3xl">
            <h1 className="text-5xl font-bold mb-6">Wellness Events</h1>
            <p className="text-xl mb-8">
              Discover yoga classes, wellness workshops, and health-focused events in San Luis Potosí. Nurture your mind, body, and spirit with our curated wellness experiences.
            </p>
          ...
          <div className="text-center py-16 bg-white rounded-xl shadow-sm">
            <div className="max-w-md mx-auto">
              ...
              <p className="text-gray-600 mb-6">
                There are no upcoming wellness events at the moment. Check back later for new yoga classes and wellness workshops!
              </p>
              <Link
                href="/"
