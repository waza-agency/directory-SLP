...
export const getStaticProps: GetStaticProps = async ({ locale }) => {
  try {
    ...
    console.log('Music events found:', eventsData?.length || 0);
...
export default function MusicEvents({ events }: MusicEventsProps) {
      ...
      <div className="relative bg-gradient-to-r from-purple-600 to-indigo-700 text-white">
        ...
        <div className="container mx-auto px-4 py-16 relative">
          <div className="max-w-3xl">
            <h1 className="text-5xl font-bold mb-6">Music Events</h1>
            <p className="text-xl mb-8">
              Experience the vibrant music scene of San Luis Potosí. From concerts and live performances to musical festivals and intimate acoustic sessions.
            </p>
                  ...
                  <div className="bg-white rounded-xl shadow-lg overflow-hidden transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
                    ...
                    <div className="p-6">
                      ...
                      <div className="mt-6 flex items-center justify-between">
                        ...
                        <button className="bg-purple-600 text-white px-4 py-2 rounded-full hover:bg-purple-700 transition-colors flex items-center gap-2">
          ...
          <div className="text-center py-16 bg-white rounded-xl shadow-sm">
            <div className="max-w-md mx-auto">
              ...
              <p className="text-gray-600 mb-6">
                There are no upcoming music events at the moment. Check back later for new concerts and performances!
              </p>
              <Link
                href="/"
