...
interface TraditionalEventsProps {
  events: Event[];
}
...
export const getStaticProps: GetStaticProps = async ({ locale = 'en' }) => {
  try {
    ...
    console.log('Traditional events found:', eventsData?.length || 0);
...
export default function TraditionalEvents({ events }: TraditionalEventsProps) {
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="relative bg-gradient-to-r from-red-600 to-orange-600 text-white">
        <div className="absolute inset-0">
          <Image
            src="/images/event-categories/traditional.jpg"
        ...
        <div className="container mx-auto px-4 py-16 relative">
          <div className="max-w-3xl">
            <h1 className="text-5xl font-bold mb-6">Traditional Events</h1>
            <p className="text-xl mb-8">
              Experience the rich cultural heritage of San Luis Potosí through traditional celebrations and festivities. Discover authentic local customs and ancestral traditions.
            </p>
          ...
          <section id="featured-events" className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {featuredEvents.map((event) => (
                <Link
                  key={event.id}
                  href={`/events/traditional/${event.id}`}
                  className="group"
                >
                  <div className="bg-white rounded-xl shadow-lg overflow-hidden transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
                    ...
                    <div className="p-6">
                      ...
                      <div className="mt-6 flex items-center justify-between">
                        <button className="text-red-600 font-semibold hover:text-red-700 flex items-center gap-1">
                          Learn More
                          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                          </svg>
                        </button>
                        <button className="bg-red-600 text-white px-4 py-2 rounded-full hover:bg-red-700 transition-colors flex items-center gap-2">
          ...
          <div className="text-center py-16 bg-white rounded-xl shadow-sm">
            <div className="max-w-md mx-auto">
              ...
              <p className="text-gray-600 mb-6">
                There are no upcoming traditional events at the moment. Check back later for new cultural celebrations!
              </p>
              <Link
                href="/"
