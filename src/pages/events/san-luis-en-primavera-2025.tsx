...
export default function SanLuisEnPrimavera() {
  ...
  return (
    <>
      <Head>
        <title>Festival San Luis en Primavera 2025 | San Luis Way</title>
        <meta
          name="description"
          content="Discover the Festival Internacional San Luis en Primavera 2025, one of Mexico's most anticipated cultural events taking place from April 12-19, 2025."
        />
      </Head>
