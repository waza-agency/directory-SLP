...
export const getStaticProps: GetStaticProps = async ({ }) => {
  try {
    ...
    console.log('Culinary events found:', eventsData?.length || 0);
...
export default function CulinaryEvents({ events }: CulinaryEventsProps) {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Hero Section */}
      <div className="relative bg-gradient-to-r from-orange-600 to-red-700 text-white">
        <div className="absolute inset-0">
          <Image
            src="/images/event-categories/culinary.jpeg"
            alt="Culinary Events"
            fill
        ...
        <div className="container mx-auto px-4 py-16 relative">
          <div className="max-w-3xl">
            <h1 className="text-5xl font-bold mb-6">Culinary Events</h1>
            <p className="text-xl mb-8">
              Discover amazing food festivals, cooking classes, and gastronomic experiences in San Luis Potosí. Explore the rich culinary traditions and modern cuisine of our region.
            </p>
                  ...
                  <div className="bg-white rounded-xl shadow-lg overflow-hidden transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
                    ...
                    <div className="p-6">
                      ...
                      <div className="mt-6 flex items-center justify-between">
                        ...
                        <button className="bg-orange-600 text-white px-4 py-2 rounded-full hover:bg-orange-700 transition-colors flex items-center gap-2">
          ...
          <div className="text-center py-16 bg-white rounded-xl shadow-sm">
            <div className="max-w-md mx-auto">
              ...
              <p className="text-gray-600 mb-6">
                There are no upcoming culinary events at the moment. Check back later for new food festivals and cooking classes!
              </p>
              <Link
                href="/"
