    ...
    <>
      ...
      <section className="py-16 bg-[#161b22]">
        <div className="container mx-auto px-4 max-w-3xl text-center">
          ...
          <div className="bg-[#0d1117] rounded-lg p-4 font-mono text-sm text-[#e6edf3] overflow-x-auto relative border border-[#30363d] text-left">
            ...
            <span className="text-[#3fb950]">$</span> {QUICK_START_CMD}
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 max-w-3xl text-center">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 text-[#6e40c9] font-medium hover:underline"
          >
          ...
          <div className="space-y-4">
            <div>
              ...
              <div className="bg-[#0d1117] rounded-lg p-4 font-mono text-sm text-[#e6edf3] overflow-x-auto relative border border-[#30363d]">
                ...
                <span className="text-[#3fb950]">$</span> {INSTALL_GLOBAL}
              </div>
            </div>
            <div>
              ...
              <div className="bg-[#0d1117] rounded-lg p-4 font-mono text-sm text-[#e6edf3] overflow-x-auto relative border border-[#30363d]">
                ...
                <span className="text-[#3fb950]">$</span> {INSTALL_NPX}
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-8 bg-white border-t border-gray-100">
        <div className="container mx-auto px-4 text-center">
          <Link href="/agent-connect" className="text-sm text-[#6e40c9] hover:underline font-medium">
