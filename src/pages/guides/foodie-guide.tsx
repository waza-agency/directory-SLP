          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="border border-gray-200 rounded-lg overflow-hidden shadow-sm">
              ...
              <div className="p-6">
                ...
                <Link href="/cultural-attractions" className="text-amber-700 hover:underline font-medium inline-flex items-center">
                  Explore Culture
            ...
            <div className="border border-gray-200 rounded-lg overflow-hidden shadow-sm">
              ...
              <div className="p-6">
                ...
                <Link href="/events/all" className="text-amber-700 hover:underline font-medium inline-flex items-center">
